...
parser.add_argument('--trainsize', type=int, default=256, help='training dataset size')#288，384
...
#------------------train_path--------------------------
image_root = 'F:\\3\\train\\image\\'
gt_root = 'F:\\3\\train\\groundtruth\\'
